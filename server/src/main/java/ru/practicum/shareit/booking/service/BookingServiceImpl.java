...
public class BookingServiceImpl implements BookingService {
    ...
    @Override
    @Transactional
    public List<BookingDto> getAllBookingsFromUserByStatus(Long userId, GetBookingState state, Integer from, Integer size) {
        ...
        List<Booking> bookingList = switch (state) {
            ...
            case FUTURE -> bookingRepository.findAllByBookerAndStartIsAfterAndStatus(user, LocalDateTime.now(),
                    StatusEnum.APPROVED, pageable);
            case WAITING -> bookingRepository.findAllByBookerAndStatus(user, StatusEnum.WAITING, pageable);
            case REJECTED -> bookingRepository.findAllByBookerAndStatus(user, StatusEnum.REJECTED, pageable);
        };
